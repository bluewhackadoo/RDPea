                ...
                <div className="space-y-3 pl-7">
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        const result = await tauri.testHyperV(form.hyperVHost || '', form.hyperVVmName);
                        setHvResult(result);
                      } catch (err: any) {
                            ...
                            {(!hvResult.state || hvResult.state !== 'Running') && (
                              <button
                                ...
                                onClick={async () => {
                                  setHvStarting(true);
                                  try {
                                    const result = await tauri.startHyperV(form.hyperVHost || '', form.hyperVVmName);
                                    if (result.success) {
                            ...
                            {hvResult.moduleMissing && (
                              <button
                                ...
                                onClick={async () => {
                                  ...
                                  try {
                                    const result = await tauri.installHyperVModule();
